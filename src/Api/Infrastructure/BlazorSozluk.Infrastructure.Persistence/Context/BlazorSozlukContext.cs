...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext : DbContext
    {
        ...
        {
            if (!optionsBuilder.IsConfigured) // Entity bizim configure edilmediyse
            {
                var connStr = "server=DESKTOP-PMQ8OOE\\MSSQLSERVER2019;database=BlazorSozlukDb;Trusted_Connection=True;Trust Server Certificate=true;integrated security=true;";
